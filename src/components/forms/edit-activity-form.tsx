...
export function EditActivityForm({ 
  ...
  // Extract date and time from dueDate if it exists
  ...
  const { date: dueDateStr, time: dueTimeStr } = formatDueDate(activity.dueDate)
  ...
  return (
    <DialogContent className="sm:max-w-[600px] max-h-[80vh] overflow-y-auto">
      <DialogHeader>
        ...
        <DialogDescription>
          Update the activity details and information.
        </DialogDescription>
      </DialogHeader>
      ...
      <form onSubmit={handleSubmit(onFormSubmit)} className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <Select onValueChange={(value) => setValue('type', value as ActivityFormData['type'])} defaultValue={activity.type}>
          ...
          <div>
            ...
            <Select onValueChange={(value) => setValue('priority', value as ActivityFormData['priority'])} defaultValue={activity.priority}>
              <SelectTrigger>
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <Select onValueChange={(value) => setValue('contactId', value)} defaultValue={activity.contact?.id}>
              <SelectTrigger>
          ...
          <div>
            ...
            <Select onValueChange={(value) => setValue('dealId', value)} defaultValue={activity.deal?.id}>
              <SelectTrigger>
        ...
        <div>
          ...
          <Select onValueChange={(value) => setValue('assigneeId', value)} defaultValue={activity.assignee.id}>
            <SelectTrigger>
